...
import mi.mobile.midevtest.feature.deliveryList.DeliveryListActivity
...
class DeliveryDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(DeliveryDetailFragment.ARG_ITEM,
                    intent.getStringExtra(DeliveryDetailFragment.ARG_ITEM))
